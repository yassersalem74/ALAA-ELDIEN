...
export default function ServiceCtaSection() {
  return (
    <section className="mx-auto flex min-h-[220px] w-full max-w-[1290px] flex-col items-center justify-center gap-8 rounded-2xl bg-[#E6E8EF] px-6 py-9 text-center md:px-24">
